        ...
        if (stim) {
            ...
            try {
                if (this.getConfigFileName() != null) {
                    ...
                    if (myConf == null) {
                        conf = Utility.setResult(conferenceTestAudit, conf, XMSReturnCode.FAILURE, call1);
                        this.checkpoints.add(conf);
                    } else {
                        conf = Utility.setResult(conferenceTestAudit, conf, XMSReturnCode.SUCCESS, call1);
                        this.checkpoints.add(conf);
